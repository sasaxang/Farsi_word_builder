        ...
        with st.form("add_affix"):
            ...
            if submitted:
                ...
                if new_prefix and not is_farsi_text(new_prefix):
                    errors.append("Prefix must be in Persian.")
                if new_root and not is_farsi_text(new_root):
                    errors.append("Root must be in Persian.")
                if new_suffix and not is_farsi_text(new_suffix):
                    errors.append("Suffix must be in Persian.")
                ...
                if errors:
                    ...
                    if added:
                        ...
                        st.success("Affixes added successfully.")
                    else:
                        st.warning("No new affix was added.")
